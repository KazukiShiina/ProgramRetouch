					...
					<div class="card-content">
						<table class="bordered">
							...
							<c:forEach var="hisList" items="${hisList}" >
								<tr>
									<td class="center">
									<a href="UserBuyHistoryDetail?buy_id=${hisList.id}" class="btn-floating btn waves-effect waves-light ">
									<i class="material-icons">details</i></a></td>
									<td class="center">${hisList.formatDate}</td>
									<td class="center">${hisList.deliveryMethodName}</td>
									<td class="center">${hisList.totalPrice}円</td>
								</tr>
							</c:forEach>
							</tbody>
						</table>
